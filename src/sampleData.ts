import { SpyDashboardData } from "./types";
...
export const sampleSpyDashboardData: SpyDashboardData = {
  ...
  serynContentRecommendations: [
    ...
    // ---- hook content (source=hook_intelligence) cho demo Hook Intelligence ----
    { week_date: WK, source: "hook_intelligence", service_category: "skin_rejuvenation", recommendation_type: "hook_content_opportunity", recommendation_id: "rec-hc-demo-doctor", source_hook_cluster_id: "hc-demo-doctor", source_brands: "Shynh House|Thu Cúc|Kangnam", hook_pattern: "authority + doctor_explains + sagging_skin", competitor_signal: "evergreen_persistence_signal", recommended_seryn_action: "adapt_angle", content_angle: "medical_trust", target_audience: "phụ nữ quan tâm trẻ hóa da (U30–U45)", pain_point: "da chảy xệ", desired_outcome: "da săn chắc, nâng cơ", proof_needed: "doctor_expert", offer_suggestion: "Soi da / đánh giá nền tảng sinh học (không đua giá)", risk_note: "Rủi ro claim thấp.", claim_risk_level: "low", claim_safe_version: "Nâng cơ hỗ trợ cải thiện độ săn chắc của da, kết quả tùy cơ địa.", avoid_phrases: "", priority: "High", confidence_score: 0.72, ad_copy_short: "Da chảy xệ là điều nhiều người gặp khi cấu trúc nâng đỡ thay đổi theo tuổi. Hiểu đúng tình trạng da là bước đầu để da săn chắc hơn. Nhắn tin để bác sĩ tư vấn.", ad_copy_medium: "Da chảy xệ thường khiến gương mặt trông mệt mỏi hơn tuổi thật.\nỞ SERYN, bác sĩ đánh giá nền tảng sinh học của làn da trước, rồi mới đề xuất lộ trình phù hợp để da săn chắc, nâng cơ.\nKết quả tùy cơ địa và tình trạng da. Nhắn tin để được tư vấn cá nhân hóa.", ad_copy_long: "Có thể bạn từng thử nhiều cách cho da chảy xệ nhưng chưa thấy phù hợp.\n\nMỗi làn da có một nền tảng sinh học riêng — độ đàn hồi, cấu trúc nâng đỡ, thói quen sống đều khác nhau. Vì vậy cùng một công nghệ, kết quả mỗi người mỗi khác.\n\nỞ SERYN, bác sĩ soi da và đánh giá nền tảng sinh học trước, sau đó cá nhân hóa lộ trình hướng tới da săn chắc, nâng cơ — tự nhiên và bền vững.\n\nKết quả tùy cơ địa và tình trạng da. Nhắn tin hoặc đặt lịch soi da để trao đổi với đội ngũ chuyên môn.", headline_options: "Hiểu đúng da chảy xệ trước khi điều trị | Da săn chắc từ nền tảng sinh học | Soi da cùng bác sĩ — hiểu da bạn cần gì | Không đua giá. Bắt đầu từ chỉ định đúng | Lộ trình nâng cơ cá nhân hóa cho riêng bạn", primary_text_options: "Da chảy xệ? Hãy bắt đầu bằng việc hiểu da bạn — đặt lịch soi da cùng SERYN.", cta_options: "Đặt lịch soi da | Nhắn tin tư vấn | Nhận tư vấn da | Kiểm tra tình trạng da | Xem liệu trình phù hợp", visual_direction: "Tông quiet luxury: ánh sáng dịu, da thật, có khoảnh khắc soi da/bác sĩ. Tránh before/after cường điệu. Đối thủ mạnh video → ưu tiên reel bác sĩ giải thích 20–40s.", video_opening_3s: "[Visual] Cận cảnh vùng da chảy xệ dưới ánh sáng soi da, chuyển sang gương mặt rạng rỡ tự nhiên. || [Voiceover] \"Da săn chắc không bắt đầu từ một liệu trình — mà từ việc hiểu chính làn da bạn.\" || [Text overlay] \"Da bạn đang ở giai đoạn nào? Soi da để biết.\"", messenger_script_angle: "Mở inbox: 'Chào bạn, bạn đang quan tâm cải thiện tình trạng da nào ạ?'\nPhân loại: 'Da bạn hiện đang gặp chảy xệ hay dấu hiệu nào khác ạ?'\nTư vấn: 'Bên mình có thể soi da để đánh giá nền tảng trước khi gợi ý lộ trình.'\nChốt lịch: 'Bạn muốn đặt lịch soi da vào buổi nào trong tuần này ạ?'", landing_page_angle: "(Objective chính là Messenger — ưu tiên kịch bản inbox/booking.)", needs_claude_hook_review: "FALSE" },
  ],

  /* Visual Intelligence demo — để trống cũng được (view tự suy luận từ adLevel).
     Thêm vài dòng mẫu để minh họa badge/score. */
  visualAnalysis: [
    { ad_id: "JW-AD-001", brand: "JW Hàn Quốc", page_id: "101055868985301", last_seen_date: WK, creative_type: "video", snapshot_url: "https://www.facebook.com/ads/library/?id=JW-AD-001", has_media_asset: false, text_overlay_summary: "Trẻ hóa bắt đầu từ hiểu cấu trúc", offer_from_visual: "tư vấn miễn phí", visual_format: "doctor_expert", visual_angle: "authority", human_presence: true, doctor_presence: true, before_after_presence: false, text_overlay_presence: true, offer_visual_presence: false, clinical_score: 80, beauty_luxury_score: 30, ugc_score: 10, trust_signal_score: 60, offer_visibility_score: 15, scroll_stop_score: 45, confidence_score: 0.55, confidence_reason: "Heuristic trên text (chưa có media).", visual_risk_level: "low", risk_reasons: [], claim_risk_score: 10, before_after_risk: "low", medical_claim_risk: "low", promotion_claim_risk: "low", visual_insight_summary: "Creative video bác sĩ giải thích cấu trúc — clinical cao, ít offer.", seryn_action: "adapt" },
    { ad_id: "LG-AD-007", brand: "LG Clinic", page_id: "138495609852248", last_seen_date: WK, creative_type: "image", snapshot_url: "https://www.facebook.com/ads/library/?id=LG-AD-007", has_media_asset: false, text_overlay_summary: "Trị nám chỉ 449K (Gốc 5.000K)", offer_from_visual: "449K (gốc 5.000K)", visual_format: "offer_banner", visual_angle: "promotion", human_presence: false, doctor_presence: false, before_after_presence: false, text_overlay_presence: true, offer_visual_presence: true, clinical_score: 10, beauty_luxury_score: 20, ugc_score: 5, trust_signal_score: 15, offer_visibility_score: 90, scroll_stop_score: 55, confidence_score: 0.55, confidence_reason: "Heuristic trên text.", visual_risk_level: "medium", risk_reasons: ["Neo giá gốc / giảm sâu"], claim_risk_score: 45, before_after_risk: "low", medical_claim_risk: "low", promotion_claim_risk: "high", visual_insight_summary: "Offer banner neo giá gốc, offer rất nổi bật — rủi ro promotion.", seryn_action: "counter" },
    { ad_id: "KN-AD-022", brand: "Kangnam", page_id: "359285057508884", last_seen_date: WK, creative_type: "video", snapshot_url: "https://www.facebook.com/ads/library/?id=KN-AD-022", has_media_asset: false, text_overlay_summary: "Cắt mí 30 phút - mắt trẻ trung", offer_from_visual: "trợ giá theo buổi", visual_format: "before_after", visual_angle: "transformation", human_presence: true, doctor_presence: false, before_after_presence: true, text_overlay_presence: true, offer_visual_presence: true, clinical_score: 25, beauty_luxury_score: 35, ugc_score: 20, trust_signal_score: 30, offer_visibility_score: 60, scroll_stop_score: 70, confidence_score: 0.55, confidence_reason: "Heuristic trên text.", visual_risk_level: "medium", risk_reasons: ["Có visual trước/sau (nhạy cảm về compliance)"], claim_risk_score: 40, before_after_risk: "medium", medical_claim_risk: "low", promotion_claim_risk: "medium", visual_insight_summary: "Before/after cắt mí — scroll-stop cao, cần review compliance B/A.", seryn_action: "adapt" },
  ],

  weeklyChangeInsights: [
    { id: "wc-da-came", brand: "Đông Á", week_start: WK, previous_week_start: "2026-06-02", change_type: "new_page_detected", severity: "medium", confidence_score: 0.7, summary: "Đông Á bật quảng cáo lại qua page Bắc Ninh.", evidence: "Active ads tăng từ 0 lên 15 (+15). Page 102483108454334 mới xuất hiện.", affected_ads: "DA-AD-003", previous_value: "0 ad", current_value: "15 ad", recommended_action: "monitor" },
    { id: "wc-jw-shift", brand: "JW Hàn Quốc", week_start: WK, previous_week_start: "2026-06-02", change_type: "service_focus_shifted", severity: "high", confidence_score: 0.75, summary: "JW dịch khỏi trẻ hóa mặt sang nâng vòng 1 + giải mã gen.", evidence: "Top dịch vụ đổi từ trẻ hóa da mặt sang đánh giá nền tảng sinh học; 2 góc tiếp cận mới xuất hiện ≥3 ad.", affected_ads: "JW-AD-022", previous_value: "facial_rejuvenation", current_value: "hormone_biology_assessment", recommended_action: "counter" },
    { id: "wc-sc-offer", brand: "Seoul Center", week_start: WK, previous_week_start: "2026-06-02", change_type: "offer_changed", severity: "medium", confidence_score: 0.65, summary: "Seoul Center đổi mồi giá xuống đồng giá 159K.", evidence: "Top offer tuần trước '290K' → tuần này 'đồng giá 159K' (≥40 ad).", previous_value: "290K", current_value: "đồng giá 159K", recommended_action: "counter" },
    { id: "wc-tc-variants", brand: "Thu Cúc", week_start: WK, previous_week_start: "2026-06-02", change_type: "same_concept_new_variants", severity: "low", confidence_score: 0.6, summary: "Thu Cúc xoay nhiều biến thể cùng concept phẫu thuật giá sốc.", evidence: "56 ad mới phần lớn cùng service=surgery + hook=offer_led.", affected_ads: "TC-AD-061", recommended_action: "ignore" },
  ],

  /* Hook Intelligence demo — cụm hook pattern trẻ hóa da (heuristic). */
  hookIntelligence: [
    { hook_cluster_id: "hc-demo-doctor", week_date: WK, service_category: "skin_rejuvenation", cluster_name: "skin_rejuvenation · authority · sagging_skin", hook_pattern: "authority + doctor_explains + sagging_skin", hook_category: "authority", hook_subcategory: "sagging_skin", hook_formula: "doctor_explains", hook_angle: "medical_trust", pain_point: "da chảy xệ", desired_outcome: "da săn chắc, nâng cơ", offer_linked: "FALSE", proof_type: "doctor_expert", ads_count: 9, brands_using: "Shynh House|Thu Cúc|Kangnam", example_ads: "SH-AD-031|TC-AD-103", example_hooks: "HIFU Linear Z dưới góc nhìn y khoa || Trẻ hơn mỗi ngày - Nâng cơ không xâm lấn", avg_active_days: 188, top_offer_linked: "FALSE", top_proof_type: "doctor_expert", top_ad_format: "video", top_inferred_objective: "messenger", scale_signal: "evergreen_persistence_signal", confidence_score: 0.72, risk_score: 12, hook_strength_score: 74, insight: "evergreen_persistence_signal: 9 ad / 3 brand dùng hook authority/doctor_explains quanh \"da chảy xệ\" · avg active 188 ngày. Tín hiệu hook đối thủ, chưa xác nhận hiệu quả.", recommended_seryn_action: "adapt_angle", needs_claude_hook_review: "FALSE", created_at: WK },
