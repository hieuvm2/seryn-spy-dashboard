...
const VI_LABELS: Record<string, string> = {
  ...
  visual: "Hình ảnh",
  cta: "CTA",
  // ---- strategic_change_type bổ sung ----
  rotating_creative: "Xoay vòng mẫu quảng cáo",
  first_week_no_comparison_available: "Tuần đầu, chưa có so sánh",
  // ---- insight_type (Action Plan) ----
  data_quality_warning: "Cảnh báo chất lượng dữ liệu",
  competitor_scaling: "Đối thủ tăng tốc",
  hook_trend: "Xu hướng hook",
  offer_trend: "Xu hướng ưu đãi",
  creative_format_trend: "Xu hướng định dạng",
  skill_psychology: "Phân tích tâm lý",
  skill_offer: "Phân tích ưu đãi",
  skill_strategy: "Phân tích chiến lược",
  skill_creative: "Đề xuất sáng tạo",
  // ---- recommendation_type / source bổ sung (phân tích chuyên sâu) ----
  counter_creative: "Mẫu quảng cáo phản đòn",
  psych_insight: "Insight tâm lý",
  claude_skill_analysis: "Phân tích chuyên sâu",
  weekly_spy: "Spy hằng tuần",
};
...
const FREE_TEXT_EN: Array<[RegExp, string]> = [
  ...
  // ---- jargon marketing hay lọt vào narrative (đồng bộ scripts/lib/viText.mjs) ----
  ...
  [/\bquiet result\b/gi, "kết quả kín đáo"],
