  ...
  return (
    <div className="hm-panel p-4 space-y-2.5">
      <div className="flex items-center gap-2 flex-wrap">
        ...
        {a.label && <span className="text-[11px] font-semibold px-2 py-1 rounded border border-slate-200 text-slate-600">{a.label}</span>}
    ...
    <motion.div initial={{ opacity: 0, y: 6 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
      ...
      <div className="space-y-3">
        <div className="flex flex-col gap-1.5 border-l-2 border-rose-500 pl-4">
          <span className="text-[11px] uppercase font-mono tracking-widest text-rose-600 font-bold">CẢNH BÁO</span>
      ...
      <div className="space-y-3">
        <div className="flex flex-col gap-1.5 border-l-2 border-cyan-500 pl-4">
          <span className="text-[11px] uppercase font-mono tracking-widest text-cyan-600 font-bold">ĐỀ XUẤT</span>
          <h3 className="text-lg font-extrabold text-slate-900 tracking-tight flex items-center gap-2">
